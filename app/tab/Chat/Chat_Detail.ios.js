          ...
          <KeyboardAvoidingView behavior='padding'>
            <View style={innerStyle.Footer}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={{ margin: 5, padding: 7, flexDirection: 'row', alignItems: 'center', flex: 1, borderWidth: 1, borderColor: '#e2e2e2', borderStyle: 'solid', borderRadius: 30, paddingLeft: 10, paddingRight: 10 }}>
