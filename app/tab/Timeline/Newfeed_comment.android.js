                  ...
                  <View style={{marginRight:10}}>
                    {
                      item.avatar == '' || item.avatar == null ?
                        ...
                        :
                        <Image style={{  width: 40, height: 40, resizeMode: 'cover', borderRadius: 20 }} source={{ uri: url + item.avatar }} />
                    }
                  </View>
                  <View>
                    ...
                    <Text style={{ fontSize: 12,color:'black',fontFamily:'Helvetica World'  }}>{item.content}</Text>
                  </View>
...
const innerStyle = StyleSheet.create({
  ...
  StatusInfo_PostContent:{color:'black'},
  StatusInfo_Avatar: { width: 50, height: 50, resizeMode: 'cover', borderRadius: 25, marginRight: 10 },
  StatusInfo_UserName: { fontSize: 15, fontWeight: 'bold',color:'black' },
