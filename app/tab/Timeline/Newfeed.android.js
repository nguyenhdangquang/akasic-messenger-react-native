    ...
    return (
      <View style={{ backgroundColor: '#fff', marginBottom: 10, padding: 10 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', }}>
          <View style={{ marginRight: 10 }}><Image style={{ width: 50, height: 50, borderRadius: 50, resizeMode: 'cover' }} source={this.props.avatar} /></View>
          <View>
            <Text style={{ fontSize: 16, fontWeight: 'bold',color:'black' }}>{this.props.name}</Text>
        ...
        >
          <View style={innerStyle.UpdateStatus}>
            <TouchableOpacity onPress={() => { this.props.navigation.navigate('Newfeed_compose'); }} activeOpacity={.8} style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: '#fff' }}>
              <Image style={{ width: 45, height: 45, borderRadius: 45, resizeMode: 'cover' }} source={{ uri: url + this.state.userAvatar }} />
