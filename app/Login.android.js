        ...
        <ScrollView style={{ flexDirection: 'column',padding:10 }}>
          <View style={innerStyle.Section}>
            ...
            <View style={innerStyle.LoginFormSection}>
              <View style={{ backgroundColor: '#fff', width: '100%', borderRadius: 10, padding: 5, }}>
